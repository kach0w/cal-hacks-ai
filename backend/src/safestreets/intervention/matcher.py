...
_KEYWORDS: list[tuple[tuple[str, ...], str]] = [
    ...
    (("lpi", "leading pedestrian", "signal timing", "concurrent", "signal phasing", "phasing"), "lpi"),
    (("sidewalk", "no sidewalk", "overgrown"), "vegetation"),
    (("pavement marking", "slow", "school zone", "lane marking"), "hi_vis_crosswalk"),
